...
Usage: install the Python packages found inside `requirements.txt`, then `uv run src/run_experiments.py` or from inside `src/` run `python run_experiments.py` to compare the methodologies on data sets in OpenML-CTR23.
